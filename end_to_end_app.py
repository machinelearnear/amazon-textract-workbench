...
def main():
    ...
    st.write('Read more here: https://docs.aws.amazon.com/comprehend/latest/dg/what-is.html')
    if input_image:
    ...
    st.write('Read more here: https://huggingface.co/')
    ...
    if input_image:
        ...
        st.warning('There is no image loaded.')
    st.header('(5) SpaCy')
    st.write('Read more here: https://spacy.io/')
    if input_image:
        if st.session_state.response:
            options = st.selectbox(
                'Select visualisers:',
